    ...
    <div className="min-h-screen bg-charcoal text-white">
      <header className="flex items-center justify-between border-b border-white/10 px-6 py-4">
        ...
        <nav className="flex gap-3 text-sm text-white/70">
          ...
          <Link href="/admin/appointments" className="hover:text-white">Appointments</Link>
          <Link href="/admin/services" className="hover:text-white">Services</Link>
          <Link href="/admin/blocks" className="hover:text-white">Blocks</Link>
          <Link href="/admin/export" className="hover:text-white">Export</Link>
        </nav>
      </header>
